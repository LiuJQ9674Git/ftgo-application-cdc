...
//    });
    ...
    orderRepository.save(same(order));

    orderAggregateEventPublisher.publish(order,
    ...
    sagaInstanceFactory.create(createOrderSaga, new CreateOrderSagaState(ORDER_ID, CHICKEN_VINDALOO_ORDER_DETAILS));
  }
